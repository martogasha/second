                    ...
                    <div class="card-body">
                        <div class="accordion" id="accordion1">
                            ...
                            <div class="accordian-header" id="headingOne">
                                <a href="{{url('m',$mpesa->id)}}"><button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><span>{{$mpesa->first_name}} {{$mpesa->last_name}}<b style="color: red;padding-left: 20px">{{$mpesa->phone}}</b> <b style="color: green;padding-left: 20px">{{$mpesa->date}}</b></span><b style="font-size: 20px"><b style="font-size: 10px">Ksh</b>{{$mpesa->amount}}</b></button></a>
                            </div>
                        </div>
                    </div>
                </div>
