    ...
    <div class="product-description pb-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="faq-heading text-center">Payment Method: <b style="font-size: 20px;color: green">Mpesa</b></h4>
                @else
                    <h4 class="faq-heading text-center">Payment Method: <b style="font-size: 20px;color: green">Cash</b></h4>
