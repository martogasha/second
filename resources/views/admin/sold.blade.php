...
<div class="page-content-wrapper">
    <div class="container">
        ...
        <div class="support-wrapper py-3">
            <div class="card">
                <div class="card-body">
                    <h4 class="faq-heading text-center">COMPLETED ORDERS</h4>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="accordion" id="accordion1">
                            ...
                            <div class="accordian-header" id="headingOne">
                                <a href="{{url('det',$order->id)}}"><button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><span><b style="font-size: 20px;color: blue">#0{{$order->id}}</b> {{$order->first_name}} {{$order->last_name}} <b style="color: red;padding-left: 40px">{{$order->phone}}</b> <b style="color: green;padding-left: 40px">{{$order->address}}</b></span><b style="font-size: 20px"><b style="font-size: 10px">Ksh</b>{{$order->total}}</b></button></a>
                            </div>
                        </div>
                    </div>
                </div>
